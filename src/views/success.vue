      ...
      <div class="left_cont">
        ...
        <div class="success_info" id="success_info">
          <ul>
            ...
            <li class="sm" v-if="successData.giveChange>0" >
              <mu-list>
								 <mu-list-item class="list sm" title="找零" :afterText="successData.giveChange | rmb"></mu-list-item>
              </mu-list>
            </li>
          </ul>
        </div>
...
export default {
  ...
  created: function() {
    ...
    this.payTypeName = this.$route.query.payType;
  ...
  methods: {
    ...
    print: function() {
      ...
      getShopOrderDetail(this.orderModel.orderId).then(function(res) {
				res.data.giveChange = self.successData.giveChange;
        self.$refs.printer.orderList(res.data,self.payTypeName);
      })
    },
    rmb: function(value) {
