      ...
      <div class="left_cont">
        <div class="print_div" id="print_div" style="width:100%;display:none;">
          ...
          <table width="100%">
            ...
            <tr v-if="chargeData.AdditionAmount">
              <td>
                <font face="隶书" size="2">活动:</font>
              </td>
              <td align="right">
                <font face="隶书" size="2">{{'充'+chargeData.ChargeAmount+'送'+chargeData.AdditionAmount}}</font>
              </td>
            </tr>
            <tr v-if="chargeData.cardName != ''">
              <td align="right" colspan="2">
                <font face="隶书" size="2">赠送一张{{chargeData.cardName}}无门槛卡</font>
              </td>
            </tr>
            <tr>
              <td>
          ...
          <ul>
            ...
            <li class="sm">
              <mu-list>
                ...
                <mu-list-item class="list sm" title="活动" v-if="chargeData.AdditionAmount>0" :afterText="'充'+chargeData.ChargeAmount+'送'+chargeData.AdditionAmount"></mu-list-item>
                <mu-list-item class="list sm" title="" v-if="chargeData.cardName!=''" :afterText="'赠送一张'+chargeData.cardName+'无门槛卡'"></mu-list-item>
  ...
  methods: {
    ...
    print: function() {
      ...
      if (this.printer == "web") {
        ...
        if(this.chargeData.AdditionAmount>0) PrintText += bleObj.cTwoRow('活动', '充' + this.chargeData.ChargeAmount + '送' + this.chargeData.AdditionAmount);
				if(this.chargeData.cardName!="") PrintText += bleObj.cTwoRow('', '赠送一张'+this.chargeData.cardName+'无门槛卡');
